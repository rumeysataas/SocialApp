...
import 'package:sosyal_medya_uygulamasi/models/duyuru.dart';
import 'package:sosyal_medya_uygulamasi/models/kullanici.dart';
import 'package:sosyal_medya_uygulamasi/sayfalar/profil.dart';
import 'package:sosyal_medya_uygulamasi/sayfalar/tekligonderi.dart';
...
class _DuyurularState extends State<Duyurular> {
  ...
  duyuruSatiri(Duyuru duyuru) {
    String mesaj = mesajOlustur(duyuru.akticiteTipi);
        ...
        builder: (context, snapshot) {
          ...
          return ListTile(
            ...
            trailing: gonderiGorsel(
                duyuru.akticiteTipi, duyuru.gonderiFoto, duyuru.gonderiId),
          );
        });
  }
